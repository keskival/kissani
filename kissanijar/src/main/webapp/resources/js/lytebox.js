// Note: This file has been modified (slight workaround) to work in Google App Engine and Facebook.
			...
			if (imageLink.getAttribute('rel').indexOf('lyteframe') != -1) {
				for (var i = 0; i < lyteLinks.length; i++) {
					...
					if (myLink.getAttribute('href') && (myLink.getAttribute('rel') == imageLink.getAttribute('rel'))) {
						...
						this.frameArray.push(new Array(myLink.getAttribute('href'), myLink.getAttribute('title'), (rev == null || rev == '' ? 'width: 400px; height: 400px; scrolling: auto;' : rev)));
					}
				}
